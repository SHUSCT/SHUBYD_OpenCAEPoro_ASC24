...
void EoS_PR::CalAiBi(const OCP_DBL& P, const OCP_DBL& T) const
{
    OCP_DBL mwi, Pri, Tri;
    for (USI i = 0; i < nc; i++) {
        if (acf[i] <= 0.49) {
...
void EoS_PR::CalAjBj(const OCP_DBL* x) const
{
    Aj = 0;
    Bj = 0;
...
//ctrl  //void EoS_PR::CalZj(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x) const
void EoS_PR::CalZj() const
{
...
void EoS_PR::CalAjBjZj(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x) const
{
    CalAiBi(P, T);
    CalAjBj(x);
    //ctrl  //CalZj(P, T, x);
...
//ctrl  //void EoS_PR::CalAxBxZx(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x) const
void EoS_PR::CalAxBxZx(const OCP_DBL* x) const
{
    Bx = Bi;
    for (USI i = 0; i < nc; i++) {
        OCP_DBL tmp = 0;
...
//ctrl  //void EoS_PR::CalAnBnZn(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x, const OCP_DBL& nt) const
void EoS_PR::CalAnBnZn(const OCP_DBL* x, const OCP_DBL& nt) const
{
    for (USI i = 0; i < nc; i++) {
        OCP_DBL tmp = 0;
        for (USI m = 0; m < nc; m++) {
...
//ctrl  //void EoS_PR::CalApBpZp(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x) const
void EoS_PR::CalApBpZp(const OCP_DBL& P) const
{
    Ap = Aj / P;
    Bp = Bj / P;
...
void EoS_PR::CalFug(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x, OCP_DBL* fug) const
{
    CalAjBjZj(P, T, x);
...
void EoS_PR::CalLnFugX(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x, OCP_DBL* lnfugx) const
{

    CalAjBjZj(P, T, x);
    //ctrl  //CalAxBxZx(P, T, x);
    CalAxBxZx(x);
...
void EoS_PR::CalLnFugN(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x, const OCP_DBL& nt, OCP_DBL* lnfugn) const
{

    CalAjBjZj(P, T, x);
    //ctrl  //CalAnBnZn(P, T, x, nt);
    CalAnBnZn(x, nt);
...
void EoS_PR::CalLnFugP(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x, OCP_DBL* lnfugP) const
{

    CalAjBjZj(P, T, x);
    //ctrl  //CalApBpZp(P, T, x);
    CalApBpZp(P);
...
void EoS_PR::CalLnPhiN(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x,
    const OCP_DBL& nt, OCP_DBL* lnphin) const
{
    OCP_DBL C, E, G;
    OCP_DBL Cnk, Dnk, Enk, Gnk;
    OCP_DBL tmp, aik;
...
OCP_DBL EoS_PR::CalVm(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x) const
{
    CalAjBjZj(P, T, x);
...
OCP_DBL EoS_PR::CalVmDer(const OCP_DBL& P, const OCP_DBL& T, const OCP_DBL* x, OCP_DBL& vmP, OCP_DBL* vmx) const
{
    CalAjBjZj(P, T, x);
    //ctrl  //CalAxBxZx(P, T, x);
    CalAxBxZx(x);
