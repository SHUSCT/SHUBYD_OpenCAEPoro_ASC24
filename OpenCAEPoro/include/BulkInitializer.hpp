...
public:
    ...
    //ctrl  //void Initialize(BulkVarSet& bvs, const PVTModule& PVTm, const SATModule& SATm, const OptionalModules& optMs, const Domain& domain);
...
protected:
    ...
    //ctrl  //void InitHydroEquilW(BulkVarSet& bvs, const PVTModule& PVTm, const SATModule& SATm, const OptionalModules& optMs, const Domain& domain);
    void InitHydroEquilW(BulkVarSet& bvs, const PVTModule& PVTm);
